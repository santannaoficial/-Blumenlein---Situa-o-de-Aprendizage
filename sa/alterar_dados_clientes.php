...
//Tela para alterar dados da conta pessoal (CLIENTE)
		 ...
		 $total = mysqli_num_rows($result_id);
			...
			// Aqui ele salva os dados do user em uma variável para que se possa manipular a info
	...
	<main>
		...
		?>
			...
			<div class="conteudo-painel">
				<form action="funcoes/editar_clientes.php" method="POST">
					...
					<div class="campo">
						...
						<textarea type="text" class="campoTexto"  name="nome_clientes"><?php echo $nome_clientes ?></textarea>
					</div>
					<div id="clear"></div>

                    <div class="campo">
						<label for="user_clientes">Nome de Usuário:</label>
						<textarea type="text" class="campoTexto"  name="user_clientes"><?php echo $user_clientes ?></textarea>
					</div>
					<div id="clear"></div>
					...
					<div class="campo">
						...
						<textarea type="text" class="campoTexto"  name="email_clientes"><?php echo $email_clientes ?></textarea>
					</div>
					<div id="clear"></div>
					...
					<div class="campo">
						...
						<textarea type="text" class="campoTexto"  name="cpf_clientes" disabled><?php echo $cpf_clientes ?></textarea>
					</div>
					<div id="clear"></div>

					<div class="campo">
						<label for="senha_clientes">Senha:</label>
						<input type="password" class="campoTexto"  name="senha_clientes" value=<?php echo $senha_clientes?>></input>
					</div>
					<div id="clear"></div>

					<div class="campo">
                    	<label for="telefone_clientes">Telefone:</label>
						<textarea type="text" class="campoTexto"  name="telefone_clientes"><?php echo $telefone_clientes?></textarea>
					</div>
					<div id="clear"></div>

					<?php
						if(isset($_GET['inclusao']) && $_GET['inclusao'] == 'erro'){
							echo '<div class="erro">'.$_GET["mensagem"].'</div>';
						}
					...
					<div class="buttons">
						<div>
							<button class="voltar" type="button" onclick="window.location.href = 'minha_conta.php';">Cancelar</button> 
						</div>
						<div>
							<button class="botao" type="submit">Confirmar Alterações</button>
						</div>
					</div>
				</form>				
			</div>
