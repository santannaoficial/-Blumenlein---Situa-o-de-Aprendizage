...
<head>
	...
	<title>Cadastro de Imagens de Fornecedores</title>
...
<body>	
	...
	<main>
		<div class="painel">
			<h2>Cadastro de Imagens de Fornecedores</h2>
			...
			<div class="conteudo-painel">
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<div class="buttons">
						<button class="voltar" onclick="location.href = 'cadastro_fornecedor.php';" type="button">Voltar para o cadastro</button>
