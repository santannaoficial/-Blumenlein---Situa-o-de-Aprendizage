...
<head>
	...
	<title>Cadastro de Imagens de Administradores</title>
...
<body>	
	...
	<main>
		<div class="painel">
			<h2>Cadastro de Imagens de Administradores</h2>
			...
			<div class="conteudo-painel">
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<div class="buttons">
						<button class="voltar" onclick="location.href = 'cadastro_administradores.php';" type="button">Voltar para o cadastro</button>
